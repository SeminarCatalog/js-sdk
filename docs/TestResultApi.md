...
[**testresultDelete**](TestResultApi.md#testresultDelete) | **DELETE** /api/testresult/{id}/{lng} | SeminarCatalog\\Rest\\Resources\\Controller\\ResourceController::delete
[**testresultGet**](TestResultApi.md#testresultGet) | **GET** /api/testresult/{id}/{lng} | SeminarCatalog\\Rest\\Resources\\Controller\\ResourceController::get
...
# **testresultDelete**
> TestResult testresultDelete(id, lng)
...
apiInstance.testresultDelete(id, lng).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
...
# **testresultGet**
> TestResult testresultGet(id, lng)
...
apiInstance.testresultGet(id, lng).then((data) => {
  console.log('API called successfully. Returned data: ' + data);
}, (error) => {
  console.error(error);
});
