...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('HotelPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.HotelPaginationResult();
      });

      it('should create an instance of HotelPaginationResult', function() {
        // TODO: update the code to test HotelPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.HotelPaginationResult);
      });
