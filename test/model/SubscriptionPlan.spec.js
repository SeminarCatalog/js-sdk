...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubscriptionPlan', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.SubscriptionPlan();
      });

      it('should create an instance of SubscriptionPlan', function() {
        // TODO: update the code to test SubscriptionPlan
        expect(instance).to.be.a(SeminarCatalogApi.SubscriptionPlan);
      });
      ...
      it('should have the property subscriptionConfiguration (base name: "subscriptionConfiguration")', function() {
        // TODO: update the code to test the property subscriptionConfiguration
        expect(instance).to.have.property('subscriptionConfiguration');
        // expect(instance.subscriptionConfiguration).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property parentChangePossible (base name: "parentChangePossible")', function() {
        // TODO: update the code to test the property parentChangePossible
        expect(instance).to.have.property('parentChangePossible');
        // expect(instance.parentChangePossible).to.be(expectedValueLiteral);
      });

      it('should have the property changeableParents (base name: "changeableParents")', function() {
        // TODO: update the code to test the property changeableParents
        expect(instance).to.have.property('changeableParents');
        // expect(instance.changeableParents).to.be(expectedValueLiteral);
      });
