...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CertificatePaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.CertificatePaginationResult();
      });

      it('should create an instance of CertificatePaginationResult', function() {
        // TODO: update the code to test CertificatePaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.CertificatePaginationResult);
      });
