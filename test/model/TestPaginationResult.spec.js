...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TestPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.TestPaginationResult();
      });

      it('should create an instance of TestPaginationResult', function() {
        // TODO: update the code to test TestPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.TestPaginationResult);
      });
