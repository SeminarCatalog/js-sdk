...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserGroupPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.UserGroupPaginationResult();
      });

      it('should create an instance of UserGroupPaginationResult', function() {
        // TODO: update the code to test UserGroupPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.UserGroupPaginationResult);
      });
