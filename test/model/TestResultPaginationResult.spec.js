...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TestResultPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.TestResultPaginationResult();
      });

      it('should create an instance of TestResultPaginationResult', function() {
        // TODO: update the code to test TestResultPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.TestResultPaginationResult);
      });
