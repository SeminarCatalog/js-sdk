...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AllocationWaitingListPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.AllocationWaitingListPaginationResult();
      });

      it('should create an instance of AllocationWaitingListPaginationResult', function() {
        // TODO: update the code to test AllocationWaitingListPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.AllocationWaitingListPaginationResult);
      });
