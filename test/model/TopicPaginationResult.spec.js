...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TopicPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.TopicPaginationResult();
      });

      it('should create an instance of TopicPaginationResult', function() {
        // TODO: update the code to test TopicPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.TopicPaginationResult);
      });
