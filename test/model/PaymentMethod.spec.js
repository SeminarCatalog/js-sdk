...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PaymentMethod', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.PaymentMethod();
      });

      it('should create an instance of PaymentMethod', function() {
        // TODO: update the code to test PaymentMethod
        expect(instance).to.be.a(SeminarCatalogApi.PaymentMethod);
      });
      ...
      it('should have the property imageSrc (base name: "imageSrc")', function() {
        // TODO: update the code to test the property imageSrc
        expect(instance).to.have.property('imageSrc');
        // expect(instance.imageSrc).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property controller (base name: "controller")', function() {
        // TODO: update the code to test the property controller
        expect(instance).to.have.property('controller');
        // expect(instance.controller).to.be(expectedValueLiteral);
      });
