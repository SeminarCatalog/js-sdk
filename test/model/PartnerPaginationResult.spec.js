...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PartnerPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.PartnerPaginationResult();
      });

      it('should create an instance of PartnerPaginationResult', function() {
        // TODO: update the code to test PartnerPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.PartnerPaginationResult);
      });
