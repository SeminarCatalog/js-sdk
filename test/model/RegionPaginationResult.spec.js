...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RegionPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.RegionPaginationResult();
      });

      it('should create an instance of RegionPaginationResult', function() {
        // TODO: update the code to test RegionPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.RegionPaginationResult);
      });
