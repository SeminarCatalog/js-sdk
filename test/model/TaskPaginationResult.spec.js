...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TaskPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.TaskPaginationResult();
      });

      it('should create an instance of TaskPaginationResult', function() {
        // TODO: update the code to test TaskPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.TaskPaginationResult);
      });
