...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('VatPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.VatPaginationResult();
      });

      it('should create an instance of VatPaginationResult', function() {
        // TODO: update the code to test VatPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.VatPaginationResult);
      });
