...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RevenueAccountPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.RevenueAccountPaginationResult();
      });

      it('should create an instance of RevenueAccountPaginationResult', function() {
        // TODO: update the code to test RevenueAccountPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.RevenueAccountPaginationResult);
      });
