...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ContactPersonPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.ContactPersonPaginationResult();
      });

      it('should create an instance of ContactPersonPaginationResult', function() {
        // TODO: update the code to test ContactPersonPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.ContactPersonPaginationResult);
      });
