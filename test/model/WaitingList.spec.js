...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WaitingList', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.WaitingList();
      });

      it('should create an instance of WaitingList', function() {
        // TODO: update the code to test WaitingList
        expect(instance).to.be.a(SeminarCatalogApi.WaitingList);
      });
