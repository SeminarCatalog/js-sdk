...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProviderInfoPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.ProviderInfoPaginationResult();
      });

      it('should create an instance of ProviderInfoPaginationResult', function() {
        // TODO: update the code to test ProviderInfoPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.ProviderInfoPaginationResult);
      });
