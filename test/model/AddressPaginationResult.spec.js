...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddressPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.AddressPaginationResult();
      });

      it('should create an instance of AddressPaginationResult', function() {
        // TODO: update the code to test AddressPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.AddressPaginationResult);
      });
