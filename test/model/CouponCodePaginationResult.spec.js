...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CouponCodePaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.CouponCodePaginationResult();
      });

      it('should create an instance of CouponCodePaginationResult', function() {
        // TODO: update the code to test CouponCodePaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.CouponCodePaginationResult);
      });
