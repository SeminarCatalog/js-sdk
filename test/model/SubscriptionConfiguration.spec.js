...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubscriptionConfiguration', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.SubscriptionConfiguration();
      });

      it('should create an instance of SubscriptionConfiguration', function() {
        // TODO: update the code to test SubscriptionConfiguration
        expect(instance).to.be.a(SeminarCatalogApi.SubscriptionConfiguration);
      });
      ...
      it('should have the property subscriptionDuration (base name: "subscriptionDuration")', function() {
        // TODO: update the code to test the property subscriptionDuration
        expect(instance).to.have.property('subscriptionDuration');
        // expect(instance.subscriptionDuration).to.be(expectedValueLiteral);
      });

      it('should have the property daysTerminationPossible (base name: "daysTerminationPossible")', function() {
        // TODO: update the code to test the property daysTerminationPossible
        expect(instance).to.have.property('daysTerminationPossible');
        // expect(instance.daysTerminationPossible).to.be(expectedValueLiteral);
      });

      it('should have the property daysInvoiceCreation (base name: "daysInvoiceCreation")', function() {
        // TODO: update the code to test the property daysInvoiceCreation
        expect(instance).to.have.property('daysInvoiceCreation');
        // expect(instance.daysInvoiceCreation).to.be(expectedValueLiteral);
      });

      it('should have the property daysUntilSuspension (base name: "daysUntilSuspension")', function() {
        // TODO: update the code to test the property daysUntilSuspension
        expect(instance).to.have.property('daysUntilSuspension');
        // expect(instance.daysUntilSuspension).to.be(expectedValueLiteral);
      });
