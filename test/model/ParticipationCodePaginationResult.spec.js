...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ParticipationCodePaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.ParticipationCodePaginationResult();
      });

      it('should create an instance of ParticipationCodePaginationResult', function() {
        // TODO: update the code to test ParticipationCodePaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.ParticipationCodePaginationResult);
      });
