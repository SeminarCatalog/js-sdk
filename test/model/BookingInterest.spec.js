...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BookingInterest', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.BookingInterest();
      });

      it('should create an instance of BookingInterest', function() {
        // TODO: update the code to test BookingInterest
        expect(instance).to.be.a(SeminarCatalogApi.BookingInterest);
      });
      ...
      it('should have the property numberLicenses (base name: "numberLicenses")', function() {
        // TODO: update the code to test the property numberLicenses
        expect(instance).to.have.property('numberLicenses');
        // expect(instance.numberLicenses).to.be(expectedValueLiteral);
      });
