...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SeminarConfiguration', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.SeminarConfiguration();
      });

      it('should create an instance of SeminarConfiguration', function() {
        // TODO: update the code to test SeminarConfiguration
        expect(instance).to.be.a(SeminarCatalogApi.SeminarConfiguration);
      });
      ...
      it('should have the property seminarDescription (base name: "seminarDescription")', function() {
        // TODO: update the code to test the property seminarDescription
        expect(instance).to.have.property('seminarDescription');
        // expect(instance.seminarDescription).to.be(expectedValueLiteral);
      });

      it('should have the property onlineCourseLicenseInfo (base name: "onlineCourseLicenseInfo")', function() {
        // TODO: update the code to test the property onlineCourseLicenseInfo
        expect(instance).to.have.property('onlineCourseLicenseInfo');
        // expect(instance.onlineCourseLicenseInfo).to.be(expectedValueLiteral);
      });
