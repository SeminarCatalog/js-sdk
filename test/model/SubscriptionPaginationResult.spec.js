...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubscriptionPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.SubscriptionPaginationResult();
      });

      it('should create an instance of SubscriptionPaginationResult', function() {
        // TODO: update the code to test SubscriptionPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.SubscriptionPaginationResult);
      });
