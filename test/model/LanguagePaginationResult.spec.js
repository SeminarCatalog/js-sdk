...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LanguagePaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.LanguagePaginationResult();
      });

      it('should create an instance of LanguagePaginationResult', function() {
        // TODO: update the code to test LanguagePaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.LanguagePaginationResult);
      });
