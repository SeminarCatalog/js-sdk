...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EventPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.EventPaginationResult();
      });

      it('should create an instance of EventPaginationResult', function() {
        // TODO: update the code to test EventPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.EventPaginationResult);
      });
