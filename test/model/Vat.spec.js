...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Vat', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.Vat();
      });

      it('should create an instance of Vat', function() {
        // TODO: update the code to test Vat
        expect(instance).to.be.a(SeminarCatalogApi.Vat);
      });
      ...
      it('should have the property defaultVat (base name: "defaultVat")', function() {
        // TODO: update the code to test the property defaultVat
        expect(instance).to.have.property('defaultVat');
        // expect(instance.defaultVat).to.be(expectedValueLiteral);
      });
