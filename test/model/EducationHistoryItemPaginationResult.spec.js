...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EducationHistoryItemPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.EducationHistoryItemPaginationResult();
      });

      it('should create an instance of EducationHistoryItemPaginationResult', function() {
        // TODO: update the code to test EducationHistoryItemPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.EducationHistoryItemPaginationResult);
      });
