...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SeminarConfigurationPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.SeminarConfigurationPaginationResult();
      });

      it('should create an instance of SeminarConfigurationPaginationResult', function() {
        // TODO: update the code to test SeminarConfigurationPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.SeminarConfigurationPaginationResult);
      });
