...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CategoryPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.CategoryPaginationResult();
      });

      it('should create an instance of CategoryPaginationResult', function() {
        // TODO: update the code to test CategoryPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.CategoryPaginationResult);
      });
