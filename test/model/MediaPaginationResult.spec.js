...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MediaPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.MediaPaginationResult();
      });

      it('should create an instance of MediaPaginationResult', function() {
        // TODO: update the code to test MediaPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.MediaPaginationResult);
      });
