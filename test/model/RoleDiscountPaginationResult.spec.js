...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RoleDiscountPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.RoleDiscountPaginationResult();
      });

      it('should create an instance of RoleDiscountPaginationResult', function() {
        // TODO: update the code to test RoleDiscountPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.RoleDiscountPaginationResult);
      });
