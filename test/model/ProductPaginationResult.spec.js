...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.ProductPaginationResult();
      });

      it('should create an instance of ProductPaginationResult', function() {
        // TODO: update the code to test ProductPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.ProductPaginationResult);
      });
