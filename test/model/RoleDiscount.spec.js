...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RoleDiscount', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.RoleDiscount();
      });

      it('should create an instance of RoleDiscount', function() {
        // TODO: update the code to test RoleDiscount
        expect(instance).to.be.a(SeminarCatalogApi.RoleDiscount);
      });
