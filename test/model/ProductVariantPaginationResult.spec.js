...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ProductVariantPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.ProductVariantPaginationResult();
      });

      it('should create an instance of ProductVariantPaginationResult', function() {
        // TODO: update the code to test ProductVariantPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.ProductVariantPaginationResult);
      });
