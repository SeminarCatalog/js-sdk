...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrganizerPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.OrganizerPaginationResult();
      });

      it('should create an instance of OrganizerPaginationResult', function() {
        // TODO: update the code to test OrganizerPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.OrganizerPaginationResult);
      });
