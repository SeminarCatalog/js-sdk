...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ParticipationPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.ParticipationPaginationResult();
      });

      it('should create an instance of ParticipationPaginationResult', function() {
        // TODO: update the code to test ParticipationPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.ParticipationPaginationResult);
      });
