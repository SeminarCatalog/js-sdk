...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.OrderPaginationResult();
      });

      it('should create an instance of OrderPaginationResult', function() {
        // TODO: update the code to test OrderPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.OrderPaginationResult);
      });
