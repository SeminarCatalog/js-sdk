...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CouponPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.CouponPaginationResult();
      });

      it('should create an instance of CouponPaginationResult', function() {
        // TODO: update the code to test CouponPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.CouponPaginationResult);
      });
