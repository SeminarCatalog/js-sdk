...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RevenueAccount', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.RevenueAccount();
      });

      it('should create an instance of RevenueAccount', function() {
        // TODO: update the code to test RevenueAccount
        expect(instance).to.be.a(SeminarCatalogApi.RevenueAccount);
      });
