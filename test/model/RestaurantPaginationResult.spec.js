...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RestaurantPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.RestaurantPaginationResult();
      });

      it('should create an instance of RestaurantPaginationResult', function() {
        // TODO: update the code to test RestaurantPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.RestaurantPaginationResult);
      });
