...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubscriptionConfigurationPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.SubscriptionConfigurationPaginationResult();
      });

      it('should create an instance of SubscriptionConfigurationPaginationResult', function() {
        // TODO: update the code to test SubscriptionConfigurationPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.SubscriptionConfigurationPaginationResult);
      });
