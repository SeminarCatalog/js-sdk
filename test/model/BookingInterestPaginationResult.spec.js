...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('BookingInterestPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.BookingInterestPaginationResult();
      });

      it('should create an instance of BookingInterestPaginationResult', function() {
        // TODO: update the code to test BookingInterestPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.BookingInterestPaginationResult);
      });
