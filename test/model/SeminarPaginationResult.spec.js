...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SeminarPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.SeminarPaginationResult();
      });

      it('should create an instance of SeminarPaginationResult', function() {
        // TODO: update the code to test SeminarPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.SeminarPaginationResult);
      });
