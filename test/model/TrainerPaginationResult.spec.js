...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TrainerPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.TrainerPaginationResult();
      });

      it('should create an instance of TrainerPaginationResult', function() {
        // TODO: update the code to test TrainerPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.TrainerPaginationResult);
      });
