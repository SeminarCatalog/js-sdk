...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UserPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.UserPaginationResult();
      });

      it('should create an instance of UserPaginationResult', function() {
        // TODO: update the code to test UserPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.UserPaginationResult);
      });
