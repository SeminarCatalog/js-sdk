...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CurrencyPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.CurrencyPaginationResult();
      });

      it('should create an instance of CurrencyPaginationResult', function() {
        // TODO: update the code to test CurrencyPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.CurrencyPaginationResult);
      });
