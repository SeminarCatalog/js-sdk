...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SubscriptionPlanPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.SubscriptionPlanPaginationResult();
      });

      it('should create an instance of SubscriptionPlanPaginationResult', function() {
        // TODO: update the code to test SubscriptionPlanPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.SubscriptionPlanPaginationResult);
      });
