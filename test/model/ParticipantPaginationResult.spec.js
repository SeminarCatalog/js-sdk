...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ParticipantPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.ParticipantPaginationResult();
      });

      it('should create an instance of ParticipantPaginationResult', function() {
        // TODO: update the code to test ParticipantPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.ParticipantPaginationResult);
      });
