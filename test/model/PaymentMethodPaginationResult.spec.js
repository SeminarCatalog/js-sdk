...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PaymentMethodPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.PaymentMethodPaginationResult();
      });

      it('should create an instance of PaymentMethodPaginationResult', function() {
        // TODO: update the code to test PaymentMethodPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.PaymentMethodPaginationResult);
      });
