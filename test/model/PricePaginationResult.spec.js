...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PricePaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.PricePaginationResult();
      });

      it('should create an instance of PricePaginationResult', function() {
        // TODO: update the code to test PricePaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.PricePaginationResult);
      });
