...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('WaitingListPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.WaitingListPaginationResult();
      });

      it('should create an instance of WaitingListPaginationResult', function() {
        // TODO: update the code to test WaitingListPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.WaitingListPaginationResult);
      });
