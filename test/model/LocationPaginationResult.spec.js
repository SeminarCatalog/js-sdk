...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('LocationPaginationResult', function() {
      beforeEach(function() {
        instance = new SeminarCatalogApi.LocationPaginationResult();
      });

      it('should create an instance of LocationPaginationResult', function() {
        // TODO: update the code to test LocationPaginationResult
        expect(instance).to.be.a(SeminarCatalogApi.LocationPaginationResult);
      });
