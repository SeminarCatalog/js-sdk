...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeminarCatalogApi.TrainerInternalApi();
  });

  describe('(package)', function() {
    describe('TrainerInternalApi', function() {
      describe('trainerCreate', function() {
        it('should call trainerCreate successfully', function(done) {
          // TODO: uncomment trainerCreate call and complete the assertions
          /*

          instance.trainerCreate().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.Trainer);
            {
      ...
      describe('trainerDelete', function() {
        it('should call trainerDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for trainerDelete call and complete the assertions
          /*
          var id = 56;

          instance.trainerDelete(id).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.Trainer);
            {
              let dataCtr = data.syncFields;
      ...
      describe('trainerGet', function() {
        it('should call trainerGet successfully', function(done) {
          // TODO: uncomment, update parameter values for trainerGet call and complete the assertions
          /*
          var id = 56;

          instance.trainerGet(id).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.Trainer);
            {
              let dataCtr = data.syncFields;
      ...
      describe('trainerList', function() {
        it('should call trainerList successfully', function(done) {
          // TODO: uncomment trainerList call and complete the assertions
          /*

          instance.trainerList().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.TrainerPaginationResult);
      ...
      describe('trainerUpdate', function() {
        it('should call trainerUpdate successfully', function(done) {
          // TODO: uncomment, update parameter values for trainerUpdate call and complete the assertions
          /*
          var id = 56;

          instance.trainerUpdate(id).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.Trainer);
            {
              let dataCtr = data.syncFields;
