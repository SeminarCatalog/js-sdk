      ...
      describe('subscriptionCreate', function() {
        it('should call subscriptionCreate successfully', function(done) {
          ...
          instance.subscriptionCreate().then(function(data) {
            ...
            expect(data).to.be.a(SeminarCatalogApi.Subscription);
            expect(data.disableDate).to.be.a('number');
            // expect(data.disableDate).to.be(0);
            expect(data.permanentFree).to.be.a('number');
            // expect(data.permanentFree).to.be(0);
      ...
      describe('subscriptionList', function() {
        it('should call subscriptionList successfully', function(done) {
          ...
          instance.subscriptionList().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.SubscriptionPaginationResult);
