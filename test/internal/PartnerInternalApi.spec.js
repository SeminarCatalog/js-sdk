...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeminarCatalogApi.PartnerInternalApi();
  });

  describe('(package)', function() {
    describe('PartnerInternalApi', function() {
      describe('partnerCreate', function() {
        it('should call partnerCreate successfully', function(done) {
          // TODO: uncomment partnerCreate call and complete the assertions
          /*

          instance.partnerCreate().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.Partner);
            {
      ...
      describe('partnerDelete', function() {
        it('should call partnerDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for partnerDelete call and complete the assertions
          /*
          var id = 56;

          instance.partnerDelete(id).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.Partner);
            {
              let dataCtr = data.syncFields;
      ...
      describe('partnerGet', function() {
        it('should call partnerGet successfully', function(done) {
          // TODO: uncomment, update parameter values for partnerGet call and complete the assertions
          /*
          var id = 56;

          instance.partnerGet(id).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.Partner);
            {
              let dataCtr = data.syncFields;
      ...
      describe('partnerList', function() {
        it('should call partnerList successfully', function(done) {
          // TODO: uncomment partnerList call and complete the assertions
          /*

          instance.partnerList().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.PartnerPaginationResult);
      ...
      describe('partnerUpdate', function() {
        it('should call partnerUpdate successfully', function(done) {
          // TODO: uncomment, update parameter values for partnerUpdate call and complete the assertions
          /*
          var id = 56;

          instance.partnerUpdate(id).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.Partner);
            {
              let dataCtr = data.syncFields;
