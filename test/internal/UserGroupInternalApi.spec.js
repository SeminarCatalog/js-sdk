...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new SeminarCatalogApi.UserGroupInternalApi();
  });

  describe('(package)', function() {
    describe('UserGroupInternalApi', function() {
      describe('usergroupCreate', function() {
        it('should call usergroupCreate successfully', function(done) {
          // TODO: uncomment usergroupCreate call and complete the assertions
          /*

          instance.usergroupCreate().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.UserGroup);
      ...
      describe('usergroupDelete', function() {
        it('should call usergroupDelete successfully', function(done) {
          // TODO: uncomment, update parameter values for usergroupDelete call and complete the assertions
          /*
          var id = 56;

          instance.usergroupDelete(id).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.UserGroup);
            expect(data.title).to.be.a('string');
            // expect(data.title).to.be("");
      ...
      describe('usergroupGet', function() {
        it('should call usergroupGet successfully', function(done) {
          // TODO: uncomment, update parameter values for usergroupGet call and complete the assertions
          /*
          var id = 56;

          instance.usergroupGet(id).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.UserGroup);
            expect(data.title).to.be.a('string');
            // expect(data.title).to.be("");
      ...
      describe('usergroupList', function() {
        it('should call usergroupList successfully', function(done) {
          // TODO: uncomment usergroupList call and complete the assertions
          /*

          instance.usergroupList().then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.UserGroupPaginationResult);
      ...
      describe('usergroupUpdate', function() {
        it('should call usergroupUpdate successfully', function(done) {
          // TODO: uncomment, update parameter values for usergroupUpdate call and complete the assertions
          /*
          var id = 56;

          instance.usergroupUpdate(id).then(function(data) {
            // TODO: update response assertions
            expect(data).to.be.a(SeminarCatalogApi.UserGroup);
            expect(data.title).to.be.a('string');
            // expect(data.title).to.be("");
