...
export class MediaInternalApi {
    ...
    */
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Media} and HTTP response
     */
    mediaDeleteWithHttpInfo(id, lng) {
      let postBody = null;
      ...
      if (lng === undefined || lng === null) {
        throw new Error("Missing the required parameter 'lng' when calling mediaDelete");
      }
     ...
     */
    mediaDelete(id, lng) {
      return this.mediaDeleteWithHttpInfo(id, lng)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
    ...
    mediaGetWithHttpInfo(id, lng) {
      ...
      // verify the required parameter 'lng' is set
      if (lng === undefined || lng === null) {
        throw new Error("Missing the required parameter 'lng' when calling mediaGet");
      }
     ...
     */
    mediaGet(id, lng) {
      return this.mediaGetWithHttpInfo(id, lng)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
