...
/**
 * The PartnerPaginationResult model module.
 * @module model/PartnerPaginationResult
 * @version 1.0.0
 */
export class PartnerPaginationResult {
  /**
 ...
 * @member {Number} limit
 */
PartnerPaginationResult.prototype.limit = undefined;

/**
 * @member {Number} offset
 */
PartnerPaginationResult.prototype.offset = undefined;

/**
 * @member {Number} entryCount
 */
PartnerPaginationResult.prototype.entryCount = undefined;

/**
 * @member {Number} maxEntryCount
 */
PartnerPaginationResult.prototype.maxEntryCount = undefined;

/**
 * @member {Array.<module:model/Partner>} entries
 */
PartnerPaginationResult.prototype.entries = undefined;
